...
def squarepath(trigger):
    ...
    camera.start_recording('Team13Mod3P2.h264')
    ...
    def drive_and_turn(j,dist=999):
        ...
        #check if an obstacle faced within 300mm (30cm)
        
            
        while not (trigger.is_set() or dist<=300):
            ...
            if(encoders_read) >= 100:
                ...
                break
        if(dist<300):
            #when object within 30cm encountered
